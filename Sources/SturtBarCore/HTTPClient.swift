...
public struct HTTPRetryPolicy: Sendable {
    ...
    public static let disabled = HTTPRetryPolicy(
        maxRetries: 0,
    ...
    public static let transientIdempotent = HTTPRetryPolicy(maxRetries: 1)
...
// MARK: - Transport handler helper

public struct HTTPTransportHandler: HTTPTransport {
...
// MARK: - Transport extension (retry logic)
...
extension HTTPTransport {
    ...
    public func response(
        ...
        retryPolicy: HTTPRetryPolicy) async throws -> HTTPResponse
    {
        var attempt = 0
        ...
        while true {
            do {
                ...
                let agentResponse = HTTPResponse(data: data, response: httpResponse)
...
public final class HTTPClient: HTTPTransport, Sendable {
    public static let shared = HTTPClient(session: HTTPClient.sharedSession())
