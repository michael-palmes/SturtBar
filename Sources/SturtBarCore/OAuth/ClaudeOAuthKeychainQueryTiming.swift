...
enum ClaudeOAuthKeychainQueryTiming {
    ...
    static func backoffIfSlowNoUIQuery(_ durationMs: Double, _ service: String, _ log: SturtBarLogger) -> Bool {
        ...
        guard InteractionContext.current == .background, durationMs > 1000 else { return false }
        log.debug(
