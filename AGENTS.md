...
Guidance for AI agents working in this repo. SturtBar is a lean, Claude Code only macOS menu bar app that tracks Claude Code usage, with zero third-party dependencies.
