// UsagePaceTests.swift — ported as-is from legacy CodexBarTests/UsagePaceTests.swift (Phase 3b).
// The UsagePaceText VIEW tests stay behind for Phase 4a with the menu card.
